...
?>
	<div id="author-info"<?php if ( !is_single() ) : ?> class="well row"<?php endif; ?>>
		<div id="author-avatar" class="col-lg-3 col-md-3 col-sm-12">
		...
		<div id="author-description" class="col-lg-9 col-md-9 col-sm-12">
			...
			<p id="author-links">
				<?php printf( __( '<a href="%s" class="www">Website</a>', 'my-theme' ), esc_url( get_the_author_meta( 'user_url' ) ) ); ?>
				<?php
					// Add new Profile fields for Users in functions.php
					function social_profile_link( $link, $title ) {
						echo ' <a href="' . esc_url( $link ) . '" title="' . $title . '">' . $title . '</a> ';
					}
